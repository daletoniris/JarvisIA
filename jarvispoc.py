...
#    print(u"\nTu dices: {}".format(text))
    ...
    if entity == 'saludojarvis':
         ...
         os.system("google_speech -l es 'hola daniel, como estas?' -e speed 1 pitch -600")
          ...
          os.system("google_speech -l es 'me alegro que te encuentres bien daniel' -e speed 1 pitch -600")
           ...
           os.system("ssh pi@192.168.1.106 python /home/pi/SpeakPy/celeste.py")
    elif entity == 'lucesverdes':
           print ("modo luz verde activado")
           os.system("google_speech -l es 'modo verde activado' -e speed 1 pitch -600")
           os.system("ssh pi@192.168.1.106 python /home/pi/SpeakPy/verde.py")
           ...
           os.system("ssh pi@192.168.1.106 python /home/pi/SpeakPy/naranja.py")
           ...
           os.system("ssh pi@192.168.1.106 python /home/pi/SpeakPy/rojo.py")
           ...
           os.system("ssh pi@192.168.1.106 python /home/pi/SpeakPy/purpura.py")
         ...
         os.system(('python3 youtube.py {} ') + (text))
          ...
          os.system("ssh pi@192.168.1.106 python /home/pi/SpeakPy/DHT11_Python/dht11_example.py")
